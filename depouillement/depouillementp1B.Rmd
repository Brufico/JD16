...
```{r}
plot2 <- plot + labs(x = "nombre de réponses fournies", y = "Poucent")
plot2
...
```{r}
res <- getresult("situation_type_etudes")
...
```{r}
res <- getresult("situation_etudes_raison")
