...
piechart(data = mpg, "drv")
piechart(data = dtf, "nam2")
...
res <- verbatim(maindf, "stg_fin_etude_raison_refus")
res <- verbatim2(maindf, "stg_fin_etude_raison_refus", "filiere")
...
mc <- cat1(mpg, "class", ordervar = "drv", orderval = "4", orderdesc = FALSE, plots = c("bar"))
mc$plot +
